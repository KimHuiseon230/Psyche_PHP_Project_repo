				...
				<div id="ripple2">
					...
					<form name="ripple_form" action="board_insert.php" method="post">
						...
						<div id="ripple_insert">
							...
							<div id="ripple_textarea"> <textarea class="form-control" name="ripple_content" id="exampleFormControlTextarea1" rows="3"></textarea></textarea></div>
							<div id="ripple_button"><input type="image" value="등록">
							</div>
