 <div class="image-slider">
   <div class="title container-center ">
     <h2 class="container d-flex justify-content-center">BEST</h2>
   </div>
   ...
   <button class="next-btn"> <a href="#" class="item"><i class="fa-solid fa-arrow-right" style="color: #ffffff;"></i></i></a></button>
 </div>