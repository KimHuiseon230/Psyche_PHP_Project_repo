...
<head>
  ...
  <script src="http://<?= $_SERVER['HTTP_HOST'] ?> /project_php/js/member.js?v=<?= date('Ymdhis') ?>"></script>
  <script src="http://<?= $_SERVER['HTTP_HOST'] . '/project_php/js/member_update.js' ?>"></script>
</head>
